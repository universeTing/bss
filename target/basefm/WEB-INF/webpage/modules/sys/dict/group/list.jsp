...
<grid:grid id="groupGridId"  baseUrl="${adminPath}/sys/dict/group">
	...
	<grid:button title="sys.dict.group.adddict"  groupname="opt" function="rowDialogDetailRefresh" outclass="btn-green"  innerclass="fa-plus" url="${adminPath}/sys/dict?gid=\"+row.id+\"" />
	...
	<grid:toolbar   title="强制刷新" btnclass="btn-green"   icon="fa-refresh"  onclick="forceRefresh()"  />

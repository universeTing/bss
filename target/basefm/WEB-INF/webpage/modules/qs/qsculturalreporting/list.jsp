...
<div class="easyui-layout" fit="true" id="cc" style="width:100%;">
	...
	<div data-options="region:'center'">
	    <grid:grid id="qsCulturalReportingGridId" url="${adminPath}/qs/qsculturalreporting/ajaxList"
	        ...
	        <shiro:hasPermission name="qs:qsculturalreporting:create">
		       <grid:toolbar btnclass="btn-green"  icon="fa-plus"  onclick="toCreate()" title="新增"/>
	        </shiro:hasPermission>
	        <shiro:hasPermission name="qs:qsculturalreporting:update">
	           <grid:toolbar function="update"/>
	        </shiro:hasPermission>
	        <shiro:hasPermission name="qs:qsculturalreporting:delete">
...
<script type="text/javascript">
   /**
	...
	function onClick(event, treeId, treeNode, clickFlag) {
	     ...
	     search('qsCulturalReportingGridIdGrid');
	}
    ...
    function dbClickRowFun(rowid,iRow,iCol,e) {
		var url='${adminPath}/qs/qsculturalreporting/'+ rowid+'/update?load=detail';
	...
	function toCreate(){
		...
		var url = "${adminPath}/qs/qsculturalreporting/create?treeId="+treeId+"&treeName="+treeName;
		if(treeId!=""){ //当树节点id为空的时候，弹出提示信息
			create("新增-文化宣传和报到",url,"qsCulturalReportingGridIdGrid","800px","450px");
		}else{

...
<html>
<head>
    <title>质量管理体系及制度制定</title>
    <meta name="decorator" content="form"/>
    <html:css name="bootstrap-fileinput" />
    <html:css name="simditor" />
</head>

<body class="white-bg"  formid="qsManagementFormulationForm">
    <form:form id="qsManagementFormulationForm" modelAttribute="data" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table  class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		        <tr>
					...
					<td class="width-40">
						<form:input path="title" class="form-control"  datatype="*" nullmsg="请输入标题！" ajaxurl="${adminPath}/qs/qsmanagementformulation/validate?orgId=${orgId}" validErrorMsg="该标题已存在"  />
				...
				<tr>
		  		...
		  		<tr>
					...
					<td class="width-40" colspan="3">
						<input id="relateTable" type="hidden" value="qs_management_formulation"/>

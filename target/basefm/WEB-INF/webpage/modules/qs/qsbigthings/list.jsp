...
<div class="easyui-layout" fit="true" id="cc" style="width:100%;">
	...
	<div data-options="region:'center'">
	    <grid:grid id="qsBigThingsGridId" url="${adminPath}/qs/qsbigthings/ajaxList"
	        ...
	        <shiro:hasPermission name="qs:qsbigthings:create">
		       <grid:toolbar btnclass="btn-green"  icon="fa-plus"  onclick="toCreate()" title="新增"/>
	        </shiro:hasPermission>
	        <shiro:hasPermission name="qs:qsbigthings:update">
	           <grid:toolbar function="update"/>
	        </shiro:hasPermission>
	        <shiro:hasPermission name="qs:qsbigthings:delete">
...
<script type="text/javascript">
   /**
    ...
    function dbClickRowFun(rowid,iRow,iCol,e) {
		var url='${adminPath}/qs/qsbigthings/'+ rowid+'/update?load=detail';
	...
	function toCreate(){
		...
		var url = "${adminPath}/qs/qsbigthings/create?treeId="+treeId+"&treeName="+treeName;
		if(treeId!=""){ //当树节点id为空的时候，弹出提示信息
			create("新增-质量管理大事记",url,"qsBigThingsGridIdGrid","800px","450px");
		}else{

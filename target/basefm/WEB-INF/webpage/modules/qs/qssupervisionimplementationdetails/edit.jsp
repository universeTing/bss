...
<body class="white-bg"  formid="qsSupervisionImplementationDetailsForm">
    <form:form id="qsSupervisionImplementationDetailsForm" modelAttribute="data" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<table  class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		   		<tr>	
					...
					<td class="width-40">
						<form:input path="title" htmlEscape="false" class="form-control" datatype="*" nullmsg="请输入标题！" 
						ajaxurl="${adminPath}/qs/qssupervisionimplementationdetails/validate?orgId=${data.orgId}" validErrorMsg="该标题已存在"   />
				...
				<tr>
					...
					<td class="width-40">
						<form:textarea path="remarks" rows="4" maxlength="200" htmlEscape="false" class="form-control"      />
						<label class="Validform_checktip"></label>
					</td>
				</tr>
				<tr>
					...
					<td class="width-40" colspan="3">
						<input id="relateTable" type="hidden" value="qs_supervision_implementation_details"/>

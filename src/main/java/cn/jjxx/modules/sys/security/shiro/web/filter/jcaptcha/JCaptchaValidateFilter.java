package cn.jjxx.modules.sys.security.shiro.web.filter.jcaptcha;
...
import cn.jjxx.modules.sys.controller.UserOnlineController;
import cn.jjxx.modules.sys.security.shiro.web.filter.authc.FormAuthenticationFilter;
import cn.jjxx.modules.sys.security.shiro.web.filter.authc.credential.RetryLimitHashedCredentialsMatcher;
...
public class JCaptchaValidateFilter extends AccessControlFilter {
	...
	protected boolean isAccessAllowed(ServletRequest request, ServletResponse response, Object mappedValue)
		...
		Collection<Session> sessions = SpringContextHolder.getBean(UserOnlineController.class).getlineSessionList();

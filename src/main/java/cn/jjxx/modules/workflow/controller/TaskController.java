 ...
 */
@Controller
@RequestMapping("${admin.url.prefix}/workflow/task")
@RequiresPathPermission("workflow:task")
public class TaskController extends BaseBeanController<Task> {
     ...
     */
    public String getTasks(Queryable queryable, PropertyPreFilterable propertyPreFilterable, HttpServletRequest request,
    ...
    public ValidJson validate(DuplicateValid duplicateValid, HttpServletRequest request) {
        ...
        try {
            EntityWrapper<Task> entityWrapper = new EntityWrapper<Task>(entityClass);
            valid = taskService.doValid(duplicateValid,entityWrapper);
            if (valid) {

...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
	...
	/**
	 * 根据指定的分隔符将string转成list
	 * @Description:  
	 * @param str 待转换字符串
	 * @param separate 字符串分隔的符号  
	 * @return List<String> .
	 * @author 周恺 
	 * @date 2017年12月6日 下午5:24:43
	 */
	...
	/**
	 * @Description: 将list转成查询需要的in .<br>
	 * @param list 传入的list.<br>   
	 * @return String .<br> 
	 * @author 郑成功 .<br>
	 * @date 2017-12-7 上午9:34:14.<br>
	 */

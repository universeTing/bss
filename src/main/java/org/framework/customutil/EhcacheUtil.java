...
public class EhcacheUtil {
	...
	//private static final URL url = EhcacheUtil.class.getClass().getResource(path);
	
	private static final URL url = EhcacheUtil.class.getClassLoader().getResource(path);      
    //CacheManager manager32 = new CacheManager(url); 

	public static CacheManager manager = CacheManager.create(url);

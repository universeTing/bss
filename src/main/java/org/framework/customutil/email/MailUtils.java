	...
	public class MailUtils {  
	    ...
	    static {  
	        try {  
	            // Test Data  
	            host = "smtp.163.com";  
	            username = "gzjjxxkj123@163.com";  
	            password = "gzjjxxkj123@";  
	            from = "gzjjxxkj123@163.com";  
	            nick = "郑成功测试群邮件发送";  
	    ...
	    public static void main(String[] args) throws AddressException,  
	        ...
	        filepath.add("E:\\mysql\\share\\czech\\errmsg.sys");  
	        //filepath.add("E:\\Resources\\Development Test\\AuctionServer\\src\\main\\java\\com\\auction\\dao\\IMemcacheDAO.java");  
	        sendMail("543507214@qq.com,xiaofu7410@vip.qq.com", "注册信息邮件", "注册邮件，有附件",  
	                filepath);  
	    }  
}

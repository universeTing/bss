package org.framework.customutil.feemarker.excel;
...
/**
 * @Title: ExcelFreemarkerUtil.java .<br>
 * @Package org.framework.customutil.feemarker.excel .<br>
 * @Description: excel模板工具类 .<br>
 * @author 郑成功 .<br>
 * @email a876459952@qq.com .<br>
 * @date 2017-11-1 上午11:34:36.<br>
 * @version V1.0.<br>
 */
public class ExcelFreemarkerUtil  extends BaseConfig{
	...
	/**
	 * @Description: 通过freemarker导出excel文件 .<br>
	...
	public static void exportExcelFile(Map<String,Object> dataMap,String TemplatePath,String TemplateName,String absolutePath,String filename){
		...
		outFileTemplate(EXCEL_SUFF);
	}
	
	/**
	 * @Description: 通过htt的response,将生成的excel输出到界面 .<br>
	...
	public static void exportExcelFile(HttpServletResponse response,Map<String,Object> dataMap,String relativePath,String TemplateName,String filename){
		...
		responseFileTemplate(response,EXCEL_SUFF);
	}
}

package org.framework.customutil.feemarker.xml;
...
/**
 * @Title: XmlFreemarkerUtil.java .<br>
 * @Package org.framework.customutil.feemarker.xml .<br>
 * @Description: xml模板工具类 .<br>
 * @author 郑成功 .<br>
 * @email a876459952@qq.com .<br>
 * @date 2017-11-1 上午11:33:52.<br>
 * @version V1.0.<br>
 */
public class XmlFreemarkerUtil  extends BaseConfig{
	...
	/**
	 * @Description: 通过freemarker导出xml文件 .<br>
	...
	public static void exportExcelFile(Map<String,Object> dataMap,String TemplatePath,String TemplateName,String absolutePath,String filename){
		...
		outFileTemplate(XML_SUFF);
	}
	
	/**
	 * @Description: 通过htt的response,将生成的xml输出到界面 .<br>
	...
	public static void exportExcelFile(HttpServletResponse response,Map<String,Object> dataMap,String relativePath,String TemplateName,String filename){
		...
		responseFileTemplate(response,XML_SUFF);
	}
}

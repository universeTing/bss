...
<div class="easyui-layout" fit="true" id="cc" style="width:100%;">
	...
	<div data-options="region:'center'">
	    <grid:grid id="qsManagementFormulationGridId" url="${adminPath}/qs/qsmanagementformulation/ajaxList"
	        ...
	        <shiro:hasPermission name="qs:qsmanagementformulation:create">
		       <grid:toolbar btnclass="btn-green"  icon="fa-plus"  onclick="toCreate()" title="新增"/>
	        </shiro:hasPermission>
	        <shiro:hasPermission name="qs:qsmanagementformulation:update">
	           <grid:toolbar function="update"/>
	        </shiro:hasPermission>
	        <shiro:hasPermission name="qs:qsmanagementformulation:delete">
...
<script type="text/javascript">
   /**
	...
	function onClick(event, treeId, treeNode, clickFlag) {
	     ...
	     search('qsManagementFormulationGridIdGrid');
	}
    ...
    function dbClickRowFun(rowid,iRow,iCol,e) {
		var url='${adminPath}/qs/qsmanagementformulation/'+ rowid+'/update?load=detail';
	...
	function toCreate(){
		...
		var url = "${adminPath}/qs/qsmanagementformulation/create?treeId="+treeId+"&treeName="+treeName;
		if(treeId!=""){ //当树节点id为空的时候，弹出提示信息
			create("新增-规章制度",url,"qsManagementFormulationGridIdGrid","800px","450px");
		}else{

...
<body class="white-bg"  formid="qsConstructionOrganizationDesignForm">
    <form:form id="qsConstructionOrganizationDesignForm" modelAttribute="data" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table  class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		        <tr>
					...
					<td class="width-40">
						<form:input path="number" htmlEscape="false" class="form-control"  datatype="*"  nullmsg="编号不能为空！"  ajaxurl="${adminPath}/qs/qsconstructionorganizationdesign/validate?orgId=${orgId}" validErrorMsg="该编号已存在" />
		  		...
		  		<tr>
					...
					<td class="width-40">
						<form:input path="title" htmlEscape="false" class="form-control"  datatype="*"  nullmsg="标题不能为空！"  />
						<label class="Validform_checktip"></label>
					</td>
		  		</tr>
		  		<tr>
				...
				<tr>
					...
					<td class="width-40" colspan="3">
						<input id="relateTable" type="hidden" value="qs_construction_organization_design"/>

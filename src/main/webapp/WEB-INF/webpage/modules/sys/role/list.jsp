...
<grid:grid id="roleGridId" url="${adminPath}/sys/role/roleAjaxList" gridSetting="{loadComplete:onloadFun}">
    <div>
	...
	<grid:button title="sys.role.authMenu"  groupname="opt" function="updateObj" outclass="btn-info" winwidth="300px" innerclass="fa-key" url="${adminPath}/sys/role/authMenu" />

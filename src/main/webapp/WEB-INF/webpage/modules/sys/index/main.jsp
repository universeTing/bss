...
<body class="gray-bg">
    <div class="row  border-bottom white-bg dashboard-header">
        <div class="col-sm-12">
            <blockquote class="text-warning" style="font-size:14px">基础开发平台是一款基于SpringMVC+Spring+Mybatis+Mybatis Plus的敏捷开发系统；它是一款具有代码生成功能的智能快速开发平台；是以Spring Framework为核心容器，Spring MVC为模型视图控制器，Mybatis为数据访问层， Apache Shiro为权限授权层，Ehcahe对常用数据进行缓存，Disruptor作为并发框架，Bootstrap作为前端框架的优秀开源系统。
<br/>目前功能模块代码生成器、权限框架、数据字典、数据缓存、并发框架、数据监控、计划任务、多数据源管理、附件管理、UI模板标签、短信发送、邮件发送、统计功能等功能。
<br/><br/>基础开发平台的开发方式采用（代码生成器快速设计生成代码->手工完善逻辑->丰富模板标签快速前端开发），可以快速协助java开发人员解决60%的重复工作，让开发人员更多关注业务逻辑的实现，框架使用前端模板标签，解放JAVA开发人员的开发压力，提高开发效率，为企业节省项目研发成本，减少开发周期。
            </blockquote>
        </div>
    </div>
            ...
            <div class="col-sm-4">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
	                    <!-- <p><i class="fa fa-send-o"></i> 官网：<a href="http://www.jjxxkj.cn/" target="_blank">http://www.jjxxkj.cn/</a></p>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
				        ...
				        <ol>
				            ...
				            <li>集成activiti在线流程配置</li>
				            <li>更多……</li>
				        </ol>
                        <hr>
                         <div class="alert alert-warning">
                               基础开发平台敏捷开发平台，可以应用在任何JAVA WEB项目的开发中，是信息化建设的良好解决方案。

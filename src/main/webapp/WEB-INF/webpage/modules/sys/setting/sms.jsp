...
<body class="gray-bg">
            ...
            <div class="col-sm-12">
                ...
                <div class="col-sm-6">
                   ...
                   <div class="col-sm-6">
	                <div class="portlet box  portlet-grey">
	                     <div class="portlet-header">
	                        <div class="caption">维那多 <a href="http://www.weinaduo.net/" target="_blank">http://www.weinaduo.net/</a></div>
	                         <div class="tools">
		                        <i class="fa fa-chevron-up"></i>
		                        <i class="fa fa-refresh"></i><i class="fa fa-times"></i>
		                     </div>
	                    ...
	                    <div class="portlet-body">
	                         <form:form id="wndSmsForm" modelAttribute="wndSms" action="${adminPath}/sys/setting/wndsms" method="post" class="form-horizontal">
	                            <div class="form-group col-sm-12">
	                                <label class="col-sm-4 control-label"><font color="red">*</font>服务器地址：</label>
	                                <div class="col-sm-8">
	                                	<form:input path="accountUrl" class="form-control"  datatype="*"   htmlEscape="false" />
	                                </div>
	                            </div>
	                            <div class="form-group col-sm-12">
	                                <label class="col-sm-4 control-label"><font color="red">*</font>账号：</label>
	                                <div class="col-sm-8">
	                                	<form:input path="account" class="form-control"  datatype="*"   htmlEscape="false" />
	                                </div>
	                            </div>
	                            <div class="form-group col-sm-12">
	                                <label class="col-sm-4 control-label"><font color="red">*</font>密码：</label>
	                                <div class="col-sm-8">
	                                    <form:input path="pws" class="form-control" defaultvalue="25"   datatype="*"    htmlEscape="false" />
	                                </div>
	                            </div>
	                             <div class="form-group col-sm-12">
	                                <label class="col-sm-4 control-label">测试电话：</label>
	                            ...
	                            <div class="form-group">
	                                <div class="col-sm-4 col-sm-offset-3" >
	                                    <input  class="btn  btn-primary" style="dispaly:none;" type="button" onclick="saveWndSms();" value="提交" />
	                                    <input  class="btn  btn-warning" style="dispaly:none;" type="button" onclick="testWndSms();" value="测试" />
	                                </div>
	                            </div>
	                        </form:form>
	                    </div>
	...
	<script type="text/javascript">
			...
			var validateWndForm;
			$(document).ready(function() {
				validateWndForm = $("#wndSmsForm").Validform({
			        tiptype:3,
			        ajaxPost:true,
			        callback:function(result){
			        	$.Hidemsg();
			...
			function saveWndSms(){
				$("#wndSmsForm").attr("action", "${adminPath}/sys/setting/wndsms");
				validateWndForm.ajaxPost();
				return false;
			}
			
			function testWndSms(){
				$("#wndSmsForm").attr("action", "${adminPath}/sys/setting/testWndSms");
				validateWndForm.ajaxPost();
				return false;
			}
	</script>

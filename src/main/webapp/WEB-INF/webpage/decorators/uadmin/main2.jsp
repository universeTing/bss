        ...
        <div class="col-sm-12">
           <div class="panel panel-default">
              <div class="panel-body">
                                                            22基础开发平台是一款基于SpringMVC+Spring+Mybatis+Mybatis Plus的敏捷开发系统；它是一款具有代码生成功能的智能快速开发平台；是以Spring Framework为核心容器，Spring MVC为模型视图控制器，Mybatis为数据访问层， Apache Shiro为权限授权层，Ehcahe对常用数据进行缓存，Disruptor作为并发框架，Bootstrap作为前端框架的优秀开源系统。
            ...
            <div class="col-sm-4">
                ...
                <div class="portlet box" style="display:none;">
                    ...
                    <div class="portlet-body">
                        <p>我们提供基于基础开发平台的二次开发服务，具体费用请联系官方。</p>
                    </div>
                </div>

...
function(a, b) {
	...
	e.prototype.init = function() {
		...
		if(f.init.call(a, b, e), "static" === b.css("position") && b.css("position", "relative"), b.css({
				...
				a.attr("data-src") ? $(this).data("origin", c) : $(this).css({"backgroundImage":"url(" + c + ")","backgroundSize":"auto 100%","backgroundRepeat":"no-repeat","backgroundPosition":"center"}), $(this).data("thumb", c).height(b.height()-105), a.remove()
...
function(a, b) {
	...
	e.prototype.defaultStyle = function() {
		var a = ".tb-list,.tb-list>*,.tb-thumb dl{position:relative;overflow:hidden}.tb-list>*>*{position:relative;float:left;min-height:1px;background-repeat:no-repeat;background-position:center top}.tb-list>.touching{-webkit-transition-duration:0ms!important;transition-duration:0ms!important}.tb-arrow{width:95%}.tb-arrow a{position:absolute;top:0;cursor:pointer}.tb-arrow a.prev{left:0}.tb-arrow a.next{right:0}.tb-arrow a img{display:inline-block;max-height:100%}.tb-btn a{display:inline-block;width:10px;height:10px;margin:0 5px;background-color:#fff;border-radius:50%;cursor:pointer}.tb-btn a.active{background-color:#09c}.tb-thumb{position:absolute;bottom:10px;left:0;width:100%;overflow:hidden}.tb-thumb a{position:absolute;width:32px;height:32px;background-repeat:no-repeat;cursor:pointer}.tb-thumb dl dd{position:relative;float:left;margin-left:0;overflow:hidden;cursor:pointer;border:3px solid #fff;opacity:.7}.tb-thumb dl dd.active{border-color:#3BB4F2;opacity:1}.tb-thumb dl dd img{position:relative;display:block;width:100%}.tb-loading{position:absolute;top:0;left:0;width:100%;height:100%}.tb-loading img{position:absolute;left:50%;width:40px;height:40px;margin-left:-20px}";

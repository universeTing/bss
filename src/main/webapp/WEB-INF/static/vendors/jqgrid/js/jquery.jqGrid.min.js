...
*/
var multiselects = false;//郑成功加上,树选择
!
function(a) {
    "use strict";
    ...
    $.fn.jqGrid = function(a) {
        ...
        return this.each(function() {
        	if(a&&a.multiselect)multiselects = a.multiselect;
            function b(a, b, c, d) {
            ...
            if (!this.grid) {
                ...
                O = function(a, b, c, d) {
                    ...
                    if (a) { - 1 !== e.p.treeANode || e.p.scroll ? b = b > 1 ? b: 1 : (J.call(e, !1, !0), b = 1);
                        ...
                        j && (e.p.data = [], e.p._index = {},
                        e.p.localReader.id = i),
                        e.p.reccount = 0,
                        ...
                        for (e.p.grouping && (Y = !0 === e.p.groupingView.groupCollapse, V = $.jgrid.getMethod("groupingPrepare")); n < t;) {
                            if (q = u[n], void 0 === (x = $.jgrid.getAccessor(q, v)) && ("number" == typeof v && null != e.p.colModel[v + C + D + K] && (x = $.jgrid.getAccessor(q, e.p.colModel[v + C + D + K].name)), void 0 === x && (x = T + n, 0 === B.length && g.cell))) {
                                ...
                                x = null != ba && void 0 !== ba[v] ? ba[v] : x,
                                ba = null
                            }
                            x = e.p.idPrefix + x,
                            U && (R = e.p.multiselect ? -1 !== $.inArray(x, e.p.selarrrow) : x === e.p.selrow);
                            var ca = P.length;
                            for (P.push(""), K && P.push(G(0, n, e.p.page, e.p.rowNum, _)), C && P.push(F(x, K, n, R, aa)), D && P.push(r.call(y, C + K, n + b)), s = N, g.repeatitems && (g.cell && (q = $.jgrid.getAccessor(q, g.cell) || q), $.isArray(q) && (s = L)), p = 0; p < s.length; p++) k = $.jgrid.getAccessor(q, s[p]),
                            O[e.p.colModel[p + C + D + K].name] = k,
                            P.push(E(x, k, p + C + D + K, n + b, q, O));
                            if (P[ca] = M(x, Y, R ? Q + " " + o: Q, O, q), P.push("</tr>"), e.p.grouping && (X.push(P), e.p.groupingView._locgr || V.call(y, O, n), P = []), (j || !0 === e.p.treeGrid && !e.p._ald) && (O[i] = $.jgrid.stripPref(e.p.idPrefix, x), e.p.data.push(O), e.p._index[O[i]] = e.p.data.length - 1), !1 === e.p.gridview && (Z.append(P.join("")), y.triggerHandler("jqGridAfterInsertRow", [x, O, q]), W && e.p.afterInsertRow.call(e, x, O, q), P = []), O = {},
                            z++, n++, z === S) break
                        }
                ...
                P = function(a) {
                    function b(a) {
                        ...
                        if (null != a.rules) try {
                            for (f = a.rules.length && "OR" === a.groupOp.toString().toUpperCase(), f && s.orBegin(), c = 0; c < a.rules.length; c++) h = a.rules[c],
                            g = a.groupOp.toString().toUpperCase(),
                            r[h.op] && h.field && (j > 0 && g && "OR" === g && (s = s.or()), i = k[h.field], "date" === i.stype && i.srcfmt && i.newfmt && i.srcfmt !== i.newfmt && (h.data = $.jgrid.parseDate.call(e, i.newfmt, h.data, i.srcfmt)), s = r[h.op](s, g)(h.field, h.data, k[h.field])),
                            j++;
                            f && s.orEnd()
                        } catch(a) {
                            alert(a)
                ...
                /*郑成功加上，判断树的多选*/
                this.p.multiselect = multiselects;
                ...
                if ("horizontal" === e.p.viewsortcols[1] ? (ua = " ui-i-asc", va = " ui-i-desc") : "single" === e.p.viewsortcols[1] && (ua = " ui-single-sort-asc", va = " ui-single-sort-desc", ta = " style='display:none'", e.p.viewsortcols[0] = !1), ja = t ? "class='ui-th-div-ie'": "", qa = "<span class='s-ico' style='display:none'>", qa += "<span sort='asc'  class='ui-grid-ico-sort ui-icon-asc" + ua + " ui-sort-" + i + " " + n + " " + r + " " + l(m, "icon_asc", !0) + "'" + ta + "></span>", qa += "<span sort='desc' class='ui-grid-ico-sort ui-icon-desc" + va + " ui-sort-" + i + " " + n + " " + r + " " + l(m, "icon_desc", !0) + "'" + ta + "></span></span>", e.p.multiSort && e.p.sortname) for (u = e.p.sortname.split(","), j = 0; j < u.length; j++) w = $.trim(u[j]).split(" "),
                u[j] = $.trim(w[0]),
                ...
                for (j = 0; j < this.p.colNames.length; j++) {
                    ...
                    "boolean" != typeof ra.title && (ra.title = !0),
                    ra.lso = "",
                ...
                if (e.p.disableClick = !1, $("th", Ba).each(function(a) {
                    ra = e.p.colModel[a],
                    la = ra.width,
                    void 0 === ra.resizable && (ra.resizable = !0),
                ...
                $(e).before(f.hDiv).on({
                    click: function(a) {
                        ...
                        if (d = !1 !== d && "stop" !== d, $.isFunction(e.p.beforeSelectRow)) {
                            var f = e.p.beforeSelectRow.call(e, oa[0].id, a); ! 1 !== f && "stop" !== f || (d = !1)
                        }
                    ...
                    reloadGrid: function(a, b) {
                        ...
                        b.current && e.grid.selectionPreserver(e), "local" === e.p.datatype ? ($(e).jqGrid("resetSelection"), e.p.data.length && (K(), L())) : e.p.treeGrid || (e.p.selrow = null, e.p.multiselect && (e.p.selarrrow = [], W(!1)), e.p.savedRow = []), e.p.scroll && J.call(e, !0, !1), b.page) {
                            var c = b.page;
                ...
                if (e.p.toppager && (e.p.toppager = $.jgrid.jqID(e.p.id) + "_toppager", f.topDiv = $("<div id='" + e.p.toppager + "'></div>")[0], e.p.toppager = "#" + e.p.toppager, $(f.topDiv).addClass(l(m, "toppagerBox", !0, "ui-jqgrid-toppager")).width(f.width - Ga).insertBefore(f.hDiv), X(e.p.toppager, "_t")), e.p.footerrow && (f.sDiv = $("<div class='ui-jqgrid-sdiv'></div>")[0], Fa = $("<div class='ui-jqgrid-hbox" + ("rtl" === i ? "-rtl": "") + "'></div>"), $(f.sDiv).append(Fa).width(f.width - Ga).insertAfter(f.hDiv), $(Fa).append(Aa), f.footers = $(".ui-jqgrid-ftable", f.sDiv)[0].rows[0].cells, e.p.rownumbers && (f.footers[0].className = l(m, "rownumBox", !0, "jqgrid-rownum")), Ea && $(f.sDiv).hide()), Fa = null, e.p.caption) {
                    var Oa = e.p.datatype; ! 0 === e.p.hidegrid && ($(".ui-jqgrid-titlebar-close", f.cDiv).click(function(a) {
        ...
        getCell: function(a, b) {
            ...
            return this.each(function() {
                ...
                if (f.grid && (d = b, isNaN(b) ? $(f.p.colModel).each(function(a) {
                    if (this.name === b) return d = this.name,
                    g = a,
                    !1
                }) : g = parseInt(b, 10), g >= 0)) {
...
function(a) {
    ...
    a.extend(a.jgrid, {
        ...
        viewModal: function(b, c) {
            ...
            c || {}), void 0 === c.focusField && (c.focusField = 0), "number" == typeof c.focusField && c.focusField >= 0 ? c.focusField = parseInt(c.focusField, 10) : "boolean" != typeof c.focusField || c.focusField ? c.focusField = 0 : c.focusField = !1, a.fn.jqm && !0 === c.jqm) c.jqM ? a(b).attr("aria-hidden", "false").jqm(c).jqmShow() : a(b).attr("aria-hidden", "false").jqmShow();
        ...
        editGridRow: function(c, d) {
            ...
            this.each(function() {
                ...
                function f(c, d, e, f) {
                    ...
                    if ("_empty" !== c && (r = a(d).jqGrid("getInd", c)), a(d.p.colModel).each(function(n) {
                        if (h = this.name, i = (!this.editrules || !0 !== this.editrules.edithidden) && !0 === this.hidden, l = i ? "style='display:none'": "", "cb" !== h && "subgrid" !== h && !0 === this.editable && "rn" !== h) {
                            ...
                            a.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {})), "select" === this.edittype && (k = a(m).val(), "select-multiple" === a(m).get(0).type && k && (k = k.join(","))), "checkbox" === this.edittype && (k = a(m).is(":checked") ? a(m).val() : a(m).attr("offval")), a(m).addClass("FormElement"), a.inArray(this.edittype, ["text", "textarea", "password", "select"]) > -1 && a(m).addClass(g.inputClass), o = !0, F) {
                                var z = a(L).find("#" + h);
                ...
                function k() {
                    ...
                    a.isFunction(b[s.p.id].beforeCheckValues) && (q = b[s.p.id].beforeCheckValues.call(s, u, a(y), w)) && "object" == typeof q && (u = q);
                ...
                if (s.grid && c) {
                    ...
                    if (F ? (I = q(b[a(this)[0].p.id].template), t = A) : (I = a("<table id='" + z + "' class='EditTable ui-common-table'><tbody></tbody></table>"), t = A + "_2"), y = "#" + a.jgrid.jqID(y), a(L).append("<div class='FormError " + h.error + "' style='display:none;'></div>"), a(L).append("<div class='tinfo topinfo'>" + b[s.p.id].topinfo + "</div>"), a(s.p.colModel).each(function() {
                        ...
                        var V = !1; ! 0 === d.closeOnEscape && (d.closeOnEscape = !1, V = !0);
                        var W;
            ...
            this.each(function() {
                ...
                if (l.grid && c) {
                    ...
                    if (a(l.p.colModel).each(function() {
                        ...
                        var G = a("<div></div>").append(x).append("<table border='0' class='EditTable' id='" + o + "_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='" + d.labelswidth + "'>" + (z ? D + C: C + D) + "</td><td class='EditButton'>" + E + "</td></tr></tbody></table>");
            ...
            if (!this.filter) {
                ...
                this.p.filter), d) {
                    ...
                    this.createTableRowForRule = function(b, c) {
                        ...
                        var A = a("<select class='selectopts " + i.srSelect + "'></select>");
                ...
                if (!d.p.filterToolbar) {
                    ...
                    k = function() {
                        ...
                        function() {
                            ...
                            f = b.searchOperators && g.searchOperMenu ? n.parent().prev().children("a").attr("soper") || b.defaultSearch: g.sopt ? g.sopt[0] : "select" === this.stype ? "eq": b.defaultSearch, c = "custom" === this.stype && a.isFunction(g.custom_value) && n.length > 0 ? g.custom_value.call(d, n, "get") : n.val(), "select" === this.stype && g.multiple && a.isArray(c) && c.length && (k = !0, l.push(e), c = 1 === c.length ? c[0] : c), "bt" === f && (m = !0), c || "nu" === f || "nn" === f) h[e] = c,
                            j[e] = f,
                            i++;
                            else try {
                        ...
                        if (!0 === b.stringResult || "local" === d.p.datatype || !0 === b.searchOperators) {
                            ...
                            }), m && (a.isPlainObject(q) || (q = a.jgrid.parse(o)), q.rules && q.rules.length)) for (r = q.rules, s = 0; s < r.length; s++) u = r[s],
                            "bt" === u.op && (v = u.data.split("..."), v.length > 1 && (void 0 === q.groups && (q.groups = []), w = {
                                groupOp: "AND",
                                groups: [],
                                rules: []
                            },
                            q.groups.push(w), a.each(v,
                            function(a) {
                                var b = 0 === a ? "ge": "le"; (t = v[a]) && w.rules.push({
                                    data: v[a],
                                    op: b,
                                    field: u.field
                                })
                            }), r.splice(s, 1), s--)); (m || k) && (o = JSON.stringify(q)),
                        ...
                        var y = "stop" === a(d).triggerHandler("jqGridToolbarBeforeSearch"); ! y && a.isFunction(b.beforeSearch) && (y = b.beforeSearch.call(d)),
                    ...
                    n = function(c, e, f) {
                        ...
                        e = parseInt(e, 10),
                        f = parseInt(f, 10) + 18;
                        for (var g, j, l = a(".ui-jqgrid-view").css("font-size") || "11px", m = '<ul id="sopt_menu" class="ui-search-menu modal-content" role="menu" tabindex="0" style="font-size:' + l + ";left:" + e + "px;top:" + f + 'px;">', n = a(c).attr("soper"), o = [], p = 0, q = a(c).attr("colname"), r = d.p.colModel.length; p < r && d.p.colModel[p].name !== q;) p++;
            ...
            return this.each(function() {
                ...
                if (i.grid && !0 === i.p.cellEdit) {
                    ...
                    if (h = i.p.colModel[c], "subgrid" !== (e = h.name) && "cb" !== e && "rn" !== e) {
                        ...
                        if (!0 !== h.editable || !0 !== d || g.hasClass("not-editable-cell") || a.isFunction(i.p.isCellEditable) && !i.p.isCellEditable.call(i, e, b, c)) parseInt(i.p.iCol, 10) >= 0 && parseInt(i.p.iRow, 10) >= 0 && a(i.rows[i.p.iRow]).removeClass("selected-row " + k).find("td:eq(" + i.p.iCol + ")").removeClass("edit-cell " + j),
                        ...
                        a.isFunction(i.p.onSelectCell) && i.p.onSelectCell.call(i, i.rows[b].id, e, f, b, c);
                            ...
                            if (i.p.autoencode && (f = a.jgrid.htmlDecode(f)), h.edittype || (h.edittype = "text"), i.p.savedRow.push({
                                ...
                                var m = i.p.formatCell.call(i, i.rows[b].id, e, f, b, c);
                                void 0 !== m && (f = m)
                            }
                            ...
                            o = a.jgrid.createEl.call(i, h.edittype, n, f, !0, a.extend({},
                            ...
                            1),
                            a("input, select, textarea", g).on("keydown",
                            function(d) {
                    ...
                    if (null !== (d = e.p.savedRow.length >= 1 ? 0 : null)) {
                        ...
                        case "custom":
                            try {
                                ...
                                if (void 0 === (h = k.editoptions.custom_value.call(e, a(".customelement", j), "get"))) throw "e2";
                                i = h
                            } catch(b) {
                        ...
                        if (i !== e.p.savedRow[d].v) {
                            var r = a(e).triggerHandler("jqGridBeforeSaveCell", [e.rows[b].id, l, h, b, c]);
                            if (r && (h = r, i = r), a.isFunction(e.p.beforeSaveCell)) {
                                var s = e.p.beforeSaveCell.call(e, e.rows[b].id, l, h, b, c);
                                s && (h = s, i = s)
                            }
                            var t = a.jgrid.checkValues.call(e, h, c),
                            u = !1;
                            if (!0 === t[0]) {
                                ...
                                var w = a(e).triggerHandler("jqGridOnSubmitCell", [e.rows[b].id, l, h, b, c]);
                                if (void 0 === w && (w = !0), a.isFunction(e.p.onSubmitCell) && void 0 === (w = e.p.onSubmitCell(e.rows[b].id, l, h, b, c)) && (w = !0), !1 === w) return;
                                    ...
                                    a.ajax(a.extend({
                                        ...
                                        complete: function(d, k) {
                                            if (a(e).jqGrid("progressBar", {
                                                ...
                                                var o = a(e).triggerHandler("jqGridAfterSubmitCell", [e, d, x.id, l, h, b, c]) || [!0, ""]; ! 0 === o[0] && a.isFunction(e.p.afterSubmitCell) && (o = e.p.afterSubmitCell.call(e, d, x.id, l, h, b, c)),
    ...
    a.jgrid.extend({
        ...
        groupingToggle: function(b) {
            return this.each(function() {
                ...
                if (n.hasClass(j)) {
                    if (m) for (; m && !(void 0 !== (g = o(m.className)) && g <= f);) a(m).hide(),
                    m = m.nextSibling,
        ...
        setTreeNode: function(b, c) {
            return this.each(function() {
                ...
                if (d.grid && d.p.treeGrid) {
                    ...
                    t = b;
                    if(this.p.multiselect){debugger;m = m+1;}//郑成功加上
                    for (a(d).triggerHandler("jqGridBeforeSetTreeNode", [t, c]), a.isFunction(d.p.beforeSetTreeNode) && d.p.beforeSetTreeNode.call(d, t, c); b < c;) {
                        ...
                        v = d.p._index[u];
                        k = d.p.data[v],
                        "nested" === d.p.treeGridModel && (k[o] || (e = parseInt(k[d.p.treeReader.left_field], 10), 
                        f = parseInt(k[d.p.treeReader.right_field], 10), k[o] = f === e + 1 ? "true": "false", d.rows[b].cells[d.p._treeleafpos].innerHTML = k[o])),
                        g = parseInt(k[p], 10),
    ...
    a.jgrid.extend({
        exportToCsv: function(b) {
            ...
            if (this.each(function() {
                function d(b, c) {
                    ...
                    var n, o, p = a.makeArray(g.groupSummary);
                    return p.reverse(),
                    a.each(g.groups,
                    function(d, l) {
                        m++;
                        ...
                        var q = "";
                        "string" != typeof(q = a.isFunction(g.groupText[l.idx]) ? g.groupText[l.idx].call(j, n, l.cnt, l.summary) : a.jgrid.template(g.groupText[l.idx], n, l.cnt, l.summary)) && "number" != typeof q && (q = n);
                        var r;
                        if (r = "header" === g.groupSummaryPos[l.idx] ? e(d, 0, g.groups, 0) : new Array(c.collen), r[0] = a.jgrid.formatCellCsv(a.jgrid.stripHtml(q), c), f += r.join(c.separator) + c.newLine, i - 1 === l.idx) {
                ...
                if (a.each(m,
                function(c, d) {
                    void 0 === d.exportcol && (d.exportcol = !0),
                ...
                if (b.includeFooter && j.p.footerrow) {
                    var B = a(".ui-jqgrid-ftable", this.sDiv);
                    if (B.length) {
                        var C = B[0].rows[0];
        ...
        exportToExcel: function(b) {
            ...
            this.each(function() {
                ...
                for (e = 0, f = m.length; e < f; e++) void 0 === m[e].exportcol && (m[e].exportcol = !0),
                !m[e].hidden && "cb" !== m[e].name && "rn" !== m[e].name && m[e].exportcol && (o.header[n] = m[e].name, o.width[n] = 5, o.map[n] = e, n++);
                ...
                s = function(c, d) {
                    ...
                    for (var e = 0; e < o.header.length; e++) {
                        var f, h = a.jgrid.excelCellPos(e) + "" + p,
                        l = a.isArray(c) && d ? g.p.colNames[o.map[e]] : c[o.header[e]];
                        if (null == l && (l = ""), d || (l = "" !== l ? a.jgrid.formatCell(l, o.map[e], c, m[o.map[e]], g) : l), o.width[e] = Math.max(o.width[e], Math.min(parseInt(l.length, 10), b.maxlength)), "number" == typeof l || l.match && a.trim(l).match(/^-?\d+(\.\d+)?$/) && !a.trim(l).match(/^0\d+/)) f = a.jgrid.makeNode(j, "c", {
                            attr: {
                                t: "n",
                                r: h
                            },
                ...
                F = o.body.length; E < F; E++) s(o.body[E], !1);
        ...
        exportToPdf: function(b) {
            ...
            this.each(function() {
                ...
                q = [],
                r = {};
                for (d = 0, e = j.length; d < e; d++) void 0 === j[d].exportcol && (j[d].exportcol = !0),
                !j[d].hidden && "cb" !== j[d].name && "rn" !== j[d].name && j[d].exportcol && (k = {
                    text: h.p.colNames[d],
                    style: "tableHeader"
                },
                ...
                if (b.includeFooter && h.p.footerrow) {
                    var w = a(h).jqGrid("footerData", "get");

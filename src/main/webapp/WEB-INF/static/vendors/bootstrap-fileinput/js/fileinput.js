...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initPreviewCache: function () {
            ...
            self.previewCache = {
                ...
                footer: function (i, isDisabled, size) {
                    ...
                    isDisabled = isDisabled === undefined ? true : isDisabled;
                    var config = data.config[i],downLoadUrl = data.content[i], caption = $h.ifSet('caption', config), actions = '',
                    ...
                    if (self.initialPreviewShowDelete) {
                        actions = self._renderFileActions(false, showDel, showZoom, showDrag, disabled, url, key, true,downLoadUrl);
                    }
        ...
        _renderFileActions: function (showUpload, showDelete, showZoom, showDrag, disabled, url, key, isInit,downLoadUrl) {
            ...
            var self = this,
                ...
                vDownLoadUrl = downLoadUrl === false ? '' : ' data-url="' + downLoadUrl + '"',
                btnDelete = '', btnUpload = '', btnZoom = '', btnDrag = '', css,
                template = self._getLayoutTemplate('actions'), config = self.fileActionSettings,
                otherButtons = self.otherActionButtons.replace(/\{dataKey}/g, vKey).replace(/\{dataUrl}/g, vDownLoadUrl),

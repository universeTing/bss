...
activitiModeler
  ...
  .config(['$selectProvider', '$translateProvider', function ($selectProvider, $translateProvider) {
      ...
      angular.extend($selectProvider.defaults, {
        ...
        $translateProvider.useStaticFilesLoader({
            prefix: './activiti/editor-app/i18n/',
            suffix: '.json'
        });
  ...
  .run(['$rootScope', '$timeout', '$modal', '$translate', '$location', '$window', '$http', '$q',
        function($rootScope, $timeout, $modal, $translate, $location, $window, $http, $q) {
            ...
            function getModelInfo(data,modelId){
                if(!data.model.properties || !data.model.properties.process_id){
                	jQuery.ajax({
                		type: 'POST',
	                	url:"service/model/findModelInfo",
	                	async:false,
	                	dataType:"json",
	                	...
	                	success:function(r){
	                		...
	                		data.model.properties.process_id = r.key;
	                		data.model.properties.name = r.name;
	                	}
	                });
                }
            }
